...
?>
	...
	<form name="myForm" id="myForm">
		...
		<span id="spanTransfer" name="spanTransfer">
			...
			<span id="spanAttendtran">
                <input type="checkbox" value="yes" id="attendtran" name="attendtran"><?php echo $locate->Translate("Attended");?>
            </span>
		</span>
	...
	<br>
	<div>
		<span id="spanDialList" name="spanDialList"></span>&nbsp;&nbsp;
		<span id="misson" name="misson">
			<input type="button" id="btnWork" name="btnWork" value="<?php echo $locate->Translate("Start work")?>">
		</span>&nbsp;
		<span id="divWork" name="divWork" align="left" style="font-weight:bold;	"></span>
	</div>

	<div id="processingMessage" name="processingMessage">
        <div class="UD"></div>
        <div class="vh">
            <div class="asterLoad">
                <div class="vZ L4XNt">
                    <span class="v1" id="processingContent"></span>
                </div>
            </div>
            <div class="asterLoad"></div>
        </div>
        <div class="UB"></div>
    </div>
	...
	<br/>
		...
		<div id="divSearchContact" name="divSearchContact" class="divSearchContact">
			<span id="divInvite">
				<input type="text" value="" name="iptSrcNumber" id="iptSrcNumber" onkeyup="if(xajax.$('iptDestNumber').value == ''){return;} var keyCode = event.keyCode ? event.keyCode : event.which ? event.which : event.charCode; if (keyCode == 13) {invite();}">&nbsp;
                <span id="inviteFlag">-></span>&nbsp;
                <SELECT id="iptDestNumber" name="iptDestNumber" ></SELECT>&nbsp;
                <input type="button" id="btnDial" name="btnDial" value="<?php echo $locate->Translate("Dial");?>" onclick="invite();">
			</span>&nbsp;&nbsp;&nbsp;
			<span id="sptSearchContact">
                <input type="text" value="" name="iptCallerid" id="iptCallerid" onkeyup="if(xajax.$('iptCallerid').value == ''){return;} var keyCode = event.keyCode ? event.keyCode : event.which ? event.which : event.charCode; if (keyCode == 13) {getContact(xajax.$('iptCallerid').value);}">&nbsp;
                <input type="button" id="btnSearchContact" name="btnSearchContact" value="<?php echo $locate->Translate("Search");?>"  onclick="getContact(xajax.$('iptCallerid').value);">&nbsp;&nbsp;
            </span>
		</div>
